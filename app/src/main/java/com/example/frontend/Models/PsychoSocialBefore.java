...
public class PsychoSocialBefore implements Serializable {
    ...
    public PsychoSocialBefore(int patient_id, int pain_xpos, int pain_ypos, int family_xpos, int family_ypos, int work_xpos, int work_ypos, int finance_xpos, int finance_ypos, int event_xpos, int event_ypos) {
